...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1em;">
  ...
  <div>
    ...
    <ul style="margin:0; padding-left:0px; list-style:none;">
      ...
      <li><a href="./DesignPatterns/9_Control_Loop.html">Control Loop</a></li>
      <li><a href="./DesignPatterns/10_Centralized_Monitoring_and_Alerts.html">Centralized Monitoring and Alerts</a></li>
    </ul>
  </div>
</div>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1em;">
  <div>
    ...
    <ul style="margin:0; padding-left:0px; list-style:none;">
      <li><a href="./MicroservicesWithSpringBoot/1_The_Rise_of_Microservices.html">The Rise of Microservices</a></li>
      <li><a href="./MicroservicesWithSpringBoot/2_Exploring_Our_Education_Microservices.html">Exploring Our Education Microservices</a></li>
      <li><a href="./MicroservicesWithSpringBoot/3_Generating_the_Skeleton_Projects.html">Generating the Skeleton Projects</a></li>
      <li><a href="./MicroservicesWithSpringBoot/4_Api_and_Util_libraries.html">Api and Util libraries</a></li>
