...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1em;">
  <div>
    <h3>Stream</h3>
      <ul style="list-style: none; padding: 0;">
        ...
        <li><a href="./stream/5_How_to_Convert_Optional_Values_into_Streams.html">Convert Optional Values into Streams</a></li>
  ...
  <div>
    ...
    <ul style="list-style: none; padding: 0;">
        ...
        <li><a href="./concurrency/6_Daemon_Threads_and_Thread_Names_and_IDs.html">Daemon Thread & Thread Name & ID</a></li>
        <li><a href="./concurrency/7_Handling_Uncaught_Exceptions.html">Handling Uncaught Exceptions</a></li>
        <li><a href="./concurrency/8_Thread_Priorities.html">How Thread Priorities Work</a></li>
        <li><a href="./concurrency/9_Creating_Thread_with_Factory_Builder.html">Creating Thread with Factory/Builder</a></li>
        <li><a href="./concurrency/10_Callables_and_Futures.html">Callables and Futures</a></li>
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1em;">
  <div>
    ...
    <ul style="list-style: none; padding: 0;">
      <li><a href="./data_structures_and_algorithms_in_java/data_structures/1_Introduction.html">Introduction</a></li>
      <li><a href="./data_structures_and_algorithms_in_java/data_structures/2_Arrays.html">Arrays</a></li>
    </ul>
  </div>
  <div>
    <h3>Algorithms</h3>
    <ul style="list-style: none; padding: 0;">
      <li><a href="./data_structures_and_algorithms_in_java/algorithms/1_Bubble_Sort.html">Bubble Sort</a></li>
    </ul>
  </div>
</div>
